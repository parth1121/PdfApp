        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="card text-center" style="width: 18rem;">
              ...
              <div class="card-body">
                <button type="submit" class="btn btn-danger">SPLIT PDF</button>
          ...
          <div class="col-md-4">
            <div class="card text-center" style="width: 18rem;">
              <img class="card-img-top" src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcRkCEObYeTjtTDkEPUuf3Hyk-0F7B1gvev_lMKTxCZ2xQC1mUey&usqp=CAU" alt="Card image cap" alt="Card image cap">
              <div class="card-body">
                <button type="submit" class="btn btn-danger">COMPRESS PDF</button>
                <p class="card-text">Reduce File size while optimising for maximal PDF Quality. This will reduce the size of PDF.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="card text-center" style="width: 18rem;">
              <img class="card-img-top" src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcRkCEObYeTjtTDkEPUuf3Hyk-0F7B1gvev_lMKTxCZ2xQC1mUey&usqp=CAU" alt="Card image cap" alt="Card image cap">
              <div class="card-body">
                <button type="submit" class="btn btn-danger">PDF TO WORD</button>
                <p class="card-text">Easily convert your PDF files into doc or docx. The converted file is of 100% doccument format.</p>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="card text-center" style="width: 18rem;">
              <img class="card-img-top" src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcRkCEObYeTjtTDkEPUuf3Hyk-0F7B1gvev_lMKTxCZ2xQC1mUey&usqp=CAU" alt="Card image cap" alt="Card image cap">
              <div class="card-body">
                <button type="submit" class="btn btn-danger">PDF TP POWERPOINT</button>
                <p class="card-text">Turn your PDF files into PDF to easy to view PPT and PPTX file. You can also see slideshows.</p>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="card text-center" style="width: 18rem;">
              <img class="card-img-top" src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcRkCEObYeTjtTDkEPUuf3Hyk-0F7B1gvev_lMKTxCZ2xQC1mUey&usqp=CAU" alt="Card image cap" alt="Card image cap">
              <div class="card-body">
                <button type="submit" class="btn btn-danger">PDF TO EXCEL</button>
